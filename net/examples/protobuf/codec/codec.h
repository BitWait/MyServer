...
#ifndef NET_EXAMPLES_PROTOBUF_CODEC_CODEC_H
#define NET_EXAMPLES_PROTOBUF_CODEC_CODEC_H
...
public:
	...
	static void fillEmptyBuffer(net::Buffer* buf, const google::protobuf::Message& message);
