...
void ProtobufCodec::fillEmptyBuffer(net::Buffer* buf, const google::protobuf::Message& message)
{
	// buf->retrieveAll();
...
void ProtobufCodec::defaultErrorCallback(const net::TcpConnectionPtr& conn,
	net::Buffer* buf,
	Timestamp,
	ErrorCode errorCode)
{
