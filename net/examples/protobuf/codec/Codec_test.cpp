...
void print(const net::Buffer& buf)
{
...
void testQuery()
{
	...
	std::shared_ptr<Query> newQuery = down_pointer_cast<Query>(message);
...
void testAnswer()
{
	...
	std::shared_ptr<Answer> newAnswer = down_pointer_cast<Answer>(message);
