  ...
  void doCommand(const string& cmd)
  {
    ...
    if (isUp)
    {
      ...
      entry.client->setConnectionCallBack(
		  std::bind(&DemuxServer::onSocksConnection, this, connId, std::placeholders::_1));
      entry.client->setMessageCallBack(
		  std::bind(&DemuxServer::onSocksMessage, this, connId, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
